...
void _sensorWebSocketOnVisible(JsonObject& root) {
    ...
    for (auto& magnitude : _magnitudes) {
        ...
        //reeopp
        #if MICS2710_SUPPORT || MICS5525_SUPPORT || MICS5524_SUPPORT
...
//reeopp case SENSOR_MICS5524_ID:
        switch (_sensors[i]->getID()) {
        case SENSOR_MICS2710_ID:
        case SENSOR_MICS5524_ID:
...
//reeopp SENSOR_MICS5524_ID ; case SENSOR_MICS5524_ID:
        #if MICS2710_SUPPORT || MICS5524_SUPPORT || MICS5525_SUPPORT
        {
